...
const UserBioUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authApiInstance().patch(`/user/patients/${patient?.user?.id}/`, formData);
      ...
      <div className="flex max-w-screen-xl mx-auto">
        ...
        <div className="flex w-3/4 md:mb-10">
          <form onSubmit={handleSubmit} className=" mx-auto">
            ...
            <label className="input input-bordered flex items-center gap-2 md:my-4">
            ...
            <button
              type="submit"
              className="btn btn-primary md:my-4"
              disabled={loading}
            >
